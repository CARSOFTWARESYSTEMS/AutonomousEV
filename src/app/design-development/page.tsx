...
export const metadata = {
  ...
  description: "End-to-end AV product engineering lifecycle for air taxis (eVTOL) and airport cargo EVs.",
};
    ...
    <div className="container" style={{ paddingTop: "120px", paddingBottom: "80px" }}>
      ...
      <div className="grid-2">
        <div className="glass-panel">
          <h2 style={{ fontSize: "1.5rem", marginBottom: "16px", color: "var(--color-accent)" }}>Autonomous Air Taxi (eVTOL)</h2>
          <p style={{ color: "var(--color-text-secondary)", marginBottom: "24px", lineHeight: 1.6 }}>
            Urban air mobility design. Navigating airspace, passenger safety protocols, vertiport integration, and urban cybersecurity risks.
          </p>
