...
export default function BatteryDiagnosticsPage() {
  return (
    <TopicPage
      ...
      whyItMatters={
        <p>A human driver can manage a degrading battery manually; an autonomous fleet cannot. Battery intelligence directly defines fleet uptime, ROI, and thermal safety. A stranded air taxi due to miscalculated State of Charge (SOC) disrupts the entire operational domain.</p>
      }
      basics={
        <>
      ...
      midLevel={
        <>
          <p><strong>Duty-Cycle Considerations:</strong> Consumer EVs sit parked 95% of the time. Autonomous air taxis (eVTOL) or airport cargo EVs run near-continuous loop cycles, vastly accelerating electrochemical degradation and impacting thermal behavior.</p>
      ...
      advanced={
        <>
          ...
          <p><strong>Use Case Specific Strategies:</strong> Airport Cargo EVs operating in high ambient temperatures require different derating algorithms than urban air taxis navigating vertical flight profiles.</p>
        </>
      }
      keyTakeaways={
        <ul>
